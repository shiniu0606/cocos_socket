...
NS_CC_BEGIN
class Integer64 :public cocos2d::Ref
{
public:
	int64_t		m_val;
...
static int toLua_Integer64_lshift(lua_State* tolua_S)
{
	int64_t data1 = toint64(tolua_S, 1);
	int64_t data2 = toint64(tolua_S, 2);
	int64_t data3 = data1 << data2;
	return new_Integer64(tolua_S, data3);
}

static int tolua_Integer64_rshift(lua_State* tolua_S)
{
	int64_t data1 = toint64(tolua_S, 1);
	int64_t data2 = toint64(tolua_S, 2);
	int64_t data3 = data1 >> data2;
...
static void register_all_Integer64()
{
    ...
    tolua_function(tolua_S, "lshift", toLua_Integer64_lshift);
    tolua_function(tolua_S, "rshift", tolua_Integer64_rshift);
